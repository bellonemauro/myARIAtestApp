...
public:
  ...
  /// set the speed to turn at in mm/sec
  AREXPORT void setSpeedToTurnAt(double speedToTurnAt) { mySpeedToTurnAt = speedToTurnAt; }
  /// set the speed to turn at in mm/sec
  AREXPORT double getSpeedToTurnAt(void) { return mySpeedToTurnAt; }
